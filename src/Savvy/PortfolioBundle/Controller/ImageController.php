...
use Savvy\PortfolioBundle\Entity\Image;
use Savvy\PortfolioBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SavvyPortfolioBundle:Image')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SavvyPortfolioBundle:Image')->find($id);
     ...
     * @Method("post")
     * @Template("SavvyPortfolioBundle:Image:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("SavvyPortfolioBundle:Image:edit.html.twig")
     */
